...
public class RestControlEmploye {
	...
	public int ajouterEntreprise(@RequestBody EntrepriseDto ssiiConsulting) {
		Entreprise persistentEntreprise  = new Entreprise(ssiiConsulting.getName(), ssiiConsulting.getRaisonSocial());

		ientrepriseservice.ajouterEntreprise(persistentEntreprise);
		return persistentEntreprise.getId();
	}
	...
	public int ajouterDepartement(@RequestBody DepartementDto dep) {
		Departement persistentDepartement  = new Departement(dep.getName());

		return ientrepriseservice.ajouterDepartement(persistentDepartement);
	}
